// AUTO-GENERATED icon map — deep per-icon imports so only used icons bundle.
// Regenerate when new icons are used. Fallback is Circle.
...
import TicketPercent from 'lucide-react/dist/esm/icons/ticket-percent.js'
